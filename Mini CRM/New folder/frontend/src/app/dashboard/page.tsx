...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const fetchStats = () => {
      ...
      // Sort activities by timestamp and get the most recent ones
    ...
    // Set up storage event listener to update stats when localStorage changes
    const handleStorageChange = (e: StorageEvent) => {
      if (e.key === 'customers' || e.key === 'segments' || e.key === 'campaigns' || e.key === 'activities') {
        fetchStats();
      }
    };
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <Button 
                ...
                className="w-full justify-start" 
                size="lg"
                onClick={() => handleQuickAction('new-segment')}
              >
              ...
              <Button 
                ...
                className="w-full justify-start" 
                size="lg"
                onClick={() => handleQuickAction('import-customers')}
              >
